...
CREATE INDEX "working_copies_owner_idx" ON "working_copies" USING btree ("owner_user_id");--> statement-breakpoint
CREATE INDEX "docs_chunks_lexemes_idx" ON "docs_chunks" USING gin ("lexemes");--> statement-breakpoint
CREATE INDEX "docs_chunks_embedding_hnsw_idx" ON "docs_chunks" USING hnsw ("embedding" vector_cosine_ops);
